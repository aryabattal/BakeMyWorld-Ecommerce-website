    ...
    public partial class CreateDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CakeCategory", x => new { x.CakesId, x.CategoriesId });
                    table.ForeignKey(
                        name: "FK_CakeCategory_Cakes_CakesId",
                        column: x => x.CakesId,
                        principalTable: "Cakes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CakeCategory_Categories_CategoriesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CakeCategory_CategoriesId",
                table: "CakeCategory",
                column: "CategoriesId");
        }
